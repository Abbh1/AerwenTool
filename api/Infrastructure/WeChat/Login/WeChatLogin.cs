...
namespace Infrastructure.WeChat.Login
{
    ...
    public class WeChatLogin
    {
        ...
        public WeChatLogin(string appid, string secret)
        {
            this.appid = appid;
            this.secret = secret;
        }
        ...
        /// <returns></returns>
        public UserInfo? GetUserInfo(string iv, string encryptedData, string session_key,string openId)
        {
            var user = JsonConvert.DeserializeObject<UserInfo>(AESDecrypt(encryptedData, session_key, iv));
            user.openId = openId;
            return user;
        }
        /// <summary>
