...
namespace DMSkin.Core
{
    public class HTTP
    {
        ...
        /// Json反序列化
        /// </summary>
        /// <typeparam name="T">data的List类型</typeparam>
        /// <param name="jsonString">json字符串</param>
        /// <returns></returns>
        public ApiResponse<T> ToListJson<T>(string jsonString)
        {
            ApiResponse<T> response = JsonConvert.DeserializeObject<ApiResponse<T>>(jsonString);
            return response;
        }

        public ApiResponseData<T> ToJson<T>(string jsonString)
        {
            var response = JsonConvert.DeserializeObject<ApiResponseData<T>>(jsonString);
            return response;
        }

        public ApiResponseDataNoType ToNoTypeJson(string jsonString)
        {
            var response = JsonConvert.DeserializeObject<ApiResponseDataNoType>(jsonString);
            return response;
        }
    ...
    /// 返回数据(无数组无类型)
    /// </summary>
    public class ApiResponseDataNoType
    {
        public int code { get; set; }
        public string msg { get; set; }
